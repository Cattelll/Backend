...
{
    public function index(Request $request): DmExaminationCollection
    {
    ...
    public function store(DmExaminationRequest $request): JsonResponse
    {
    ...
    public function show(Request $request, DmExamination $dmExamination): JsonResponse
    {
    ...
    public function update(DmExaminationRequest $request, DmExamination $dmExamination): JsonResponse
    {
        if ($dmExamination->puskesmas_id !== $request->user()->puskesmas->id) {
            return response()->json([
                'message' => 'Unauthorized',
